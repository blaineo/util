...
if(0>a||a>b.length-1)throw new Error("Playlist index "+a+" is out of range [0-"+b.length+"]");return b[a]},updateCurrent:function(){this.currentItem=this.metadata.items[this.currentIndex]}},e.Events),k.extend=e.extend,e.Playlist=k,c.provide("mtvn-util",e),a.Handlebars=d,b.noConflict()}(window),MTVNPlayer.require("mtvn-util").version="1.6.1",MTVNPlayer.require("mtvn-util").build="01/31/2014 10:34:46 PM";