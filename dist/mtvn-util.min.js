...
return b[a]},updateCurrent:function(){this.currentItem=this.metadata.items[this.currentIndex]}},e.Events),k.extend=e.extend,e.Playlist=k,c.provide("mtvn-util",e),a.Handlebars=d,b.noConflict()}(this),MTVNPlayer.require("mtvn-util").version="1.6.0",MTVNPlayer.require("mtvn-util").build="01/06/2014 04:48:22 PM";